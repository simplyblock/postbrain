...
ALTER TABLE {{POSTBRAIN_SCHEMA}}.knowledge_artifacts
    ADD COLUMN supersedes_artifact_id UUID REFERENCES {{POSTBRAIN_SCHEMA}}.knowledge_artifacts(id) ON DELETE SET NULL;
...
CREATE INDEX knowledge_artifacts_artifact_kind_idx
    ON {{POSTBRAIN_SCHEMA}}.knowledge_artifacts (artifact_kind, status, owner_scope_id);

CREATE INDEX knowledge_artifacts_supersedes_idx
    ON {{POSTBRAIN_SCHEMA}}.knowledge_artifacts (supersedes_artifact_id)
